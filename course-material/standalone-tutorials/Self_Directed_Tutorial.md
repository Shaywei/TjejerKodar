...
Download the file `https://github.com/Shaywei/TjejerKodar/blob/master/scripts/nobel.py` by right-clicking on it and saying to save it as a ".py" file to your Desktop. The ".py" extension hints that this is a Python script.  
